...
The stripping radius now carries a propagated confidence interval, the
comparison sample has been re-derived on a matched stellar-mass calibration,
and the quenching timescale claimed in the abstract is now derived in the
Results rather than asserted. We have declined one request — Referee 1's point
...
We are grateful to both referees; the error budget in particular has made the
central claim considerably more defensible than it was.
