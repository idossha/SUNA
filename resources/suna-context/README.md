...
<project>/
  ...
  context/
    PROJECT.md          # charter: Question / Data / Prior work / Deliverable / Scope
    MEMORY.md           # agent memory: State / Decisions / Tried / Open qs / Session log
...
| context/PROJECT.md | co-owned; user has final say | edit with the user's agreement |
| context/MEMORY.md | agent | user reads and leaves comments; you edit it surgically, as you work (see WORKFLOW.md) |
