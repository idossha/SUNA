...
export interface ParsedReference {
  ...
  number: number | null
  /** Family-first ("Nolan, G."), whatever order the source wrote them in. */
  authors: string[]
  year: string | null
  title: string | null
  journal: string | null
...
/**
 * "G. Nolan" → "Nolan, G." — the family-first form the rest of this module
...
/** Authors of an IEEE-style entry: "G. Nolan, C. Reyes, and R. Foster". */
 ...
 *
 *   G. Nolan and C. Reyes, "Sleep and the price of plasticity," Neuron,
 ...
 * "authors end at the first period" rule instead turns "G. Nolan" into an
 * author named "G" and the rest of the citation into a title, which is how a
 * whole bibliography ends up keyed `g2014nolan`.
 */
