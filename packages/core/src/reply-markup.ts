 ...
 *
 * | voice | Findlay reply-to-referees | TI-Toolbox response |
 * |---|---|---|
 ...
 * ones: `#0432FF` is the blue in both documents, `#EE0000` the red Findlay
 * uses for revised prose (TI-Toolbox uses `#FF0000`; they are the same
